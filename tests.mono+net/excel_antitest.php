...
$wb = new mono("org.apache.poi.hssf.usermodel.HSSFWorkbook");
$sheet = $wb->createSheet("new sheet");
$row = $sheet->createRow(0);

//Aqua background
$style = $wb->createCellStyle();
$aqua = new mono ('org.apache.poi.hssf.util.HSSFColor$AQUA');
...
$orange = new mono ('org.apache.poi.hssf.util.HSSFColor$ORANGE');
