<?php /*-*- mode: php; tab-width:4 -*-*/
  ...
  /* java_Java.php -- for backward compatibility.
...
if(!extension_loaded('java')) {
  ...
  function java_get_closure() {return java_closure_internal(func_get_args());}
  function java_get_values($arg) { return java_values($arg); }
  function java_get_session() {return java_session_internal(func_get_args());}
  function java_get_context() {return java_context(); }
  function java_get_server_name() { return java_servername(); }
